...
data class ShieldConfig(
    ...
    companion object {
        ...
        val DEFAULT = ShieldConfig(
            ...
            subtitleColor = 0xFFFFFFFF.toInt(),
        ...
        fun fromMap(configMap: Map<String, Any?>): ShieldConfig {
            return ShieldConfig(
                ...
                backgroundColor = (configMap["backgroundColor"] as? Number)?.toInt() ?: 0xFF000000.toInt(),
                titleColor = (configMap["titleColor"] as? Number)?.toInt() ?: 0xFFFFFFFF.toInt(),
                subtitleColor = (configMap["subtitleColor"] as? Number)?.toInt() ?: 0xFFFFFFFF.toInt(),
        ...
        fun fromJson(serialized: String): ShieldConfig {
            ...
            return ShieldConfig(
                ...
                backgroundColor = payload.optInt(KEY_BACKGROUND_COLOR, 0xFF000000.toInt()),
                titleColor = payload.optInt(KEY_TITLE_COLOR, 0xFFFFFFFF.toInt()),
                subtitleColor = payload.optInt(KEY_SUBTITLE_COLOR, 0xFFFFFFFF.toInt()),
